...
class Analysis:
    ...
    def problem_analysis(self):
        ...
        subject_score_analysis = self.subject_score_analysis(Class_name, subject_total_score, subject_full_score, index)
    ...
    def subject_score_analysis(self, Class_name, subject_total_score, subject_full_score, index):
